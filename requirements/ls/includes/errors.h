...
/*---------------------------Macros---------------------------*/
    ...
    #define ENOENT(file) ft_printf(ENOENT_FMT, (file)) // Directory does not exist, or name is an empty string.
    ...
    #define INVALID_OPTION(file) ft_printf(INVALID_OPTION_FMT, (file)) // Invalid option.
